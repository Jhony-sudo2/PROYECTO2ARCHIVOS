...
db.files.insertMany([
    ...
    {name:'TEXTO',content:'<mensaje prueba>',path:'/',user:'Jhony19',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'EXAMEN',content:'MENSAJE DE PRUEBA',path:'/',user:'LuisM2',extension:'txt',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'HORARIO',content:'HOLA ESTE ES UN MENSAJE',path:'/',user:'Fer1202',extension:'txt',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'TOKEN',content:'<h1>PRUEBA<h1>',path:'/',user:'Fer1202',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'codigos',content:'',path:'/',user:'AleLo',extension:'txt',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'L',content:'',path:'/',user:'Jhony19',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'T',content:'',path:'/',user:'AleLo',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'Encabezado',content:'',path:'/',user:'Jhony19',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'Tabla modelo',content:'HOLA E',path:'/',user:'Car20',extension:'txt',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0},
    {name:'Pagina1',content:'NUEVO MENSAJE',path:'/',user:'Fer1202',extension:'html',fecha:'11/11/2023, 9:07:52 GMT-6',contador:0}
    ]
)
